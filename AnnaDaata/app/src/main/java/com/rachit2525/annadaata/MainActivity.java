...
import com.rachit2525.annadaata.Remote.ICloudFunctions;
import com.rachit2525.annadaata.Remote.RetrofitCloudClient;
    ...
    private void init() {
        ...
        listener = firebaseAuth -> {
            ...
            if (user != null) {
                ...
                //Not Logged in..
///////////////////////////////////////////////////////////yahan pe firebase ka change hoga..............//////////////////////////
                phoneLogin();
                ////////////////////////////////////////////////////////////////////////////////////////////
            }
        };
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    dialogInterface.dismiss();
                                    Toast.makeText(MainActivity.this, "Congratulations! Registration successful", Toast.LENGTH_SHORT).show();
                                    goToHomeActivity(userModel);
    ...
    private void phoneLogin() {
        ...
        ///////////////////////////////// yahan pe bhi vahnge higa bahut saara......//////////////////////////////
